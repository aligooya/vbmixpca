function [C, L, U, Dist] = mySpectralClustering(W, k, Type)
...
% each data point
%[C,~,~,Dist] = kmeans(U, k, 'start', 'cluster', ...
%                 'EmptyAction', 'singleton','Replicate',20);
[C,~,~,Dist] = kmeans(U, k, 'EmptyAction', 'singleton','Replicate',1000);            
